    ...
    <div className="flex flex-col  space-x-8 md:flex-row items-center justify-between w-full max-w-[98vw] lg:max-w-[80vw] space-y-10 md:space-y-0 border-b-2 border-zinc-200 dark:border-zinc-800 pb-4 mt-32">
      ...
      <div className="flex flex-col space-y-4 text-center md:text-left max-w-lg">
        ...
        <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
          Note-Keep is a simple and intuitive note-taking app designed to help
          you stay organized. Whether you need to jot down quick ideas, create
          to-do lists, or keep important reminders, Note-Keep makes it easy.
          Stay productive by keeping all your important thoughts in one place,
          accessible anytime.
        </p>
        {/* Get Started Button */}
        <button
