      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col items-center space-y-4 sm:flex-row sm:justify-between sm:space-y-0">
          ...
          <div className="text-center sm:text-left">
            <h3 className="text-xl font-semibold text-teal-500">Note Keep</h3>
            <p className="mt-2 text-sm text-black/70 dark:text-zinc-400">
              A simple, intuitive note-taking app to help you stay organized and
              productive.
            </p>
          </div>
          ...
          <div className="flex space-x-6 mt-4 sm:mt-0">
            <Link href="/about" className="hover:text-teal-500 transition-all">
              About
            </Link>
            <Link
              href="/features"
        ...
        <div className="mt-8 border-t border-zinc-300 dark:border-zinc-700 pt-4 text-center">
          <p className="text-sm text-black/70 dark:text-zinc-400">
            &copy; {new Date().getFullYear()} Note Keep. All Rights Reserved.
          </p>
        </div>
      </div>
    </div>
