      ...
      <div className="flex flex-col items-center justify-center space-y-6 pb-4 border-b-2 border-zinc-200 dark:border-zinc-800 w-[80vw]">
         ...
         <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {featureData.map((feature) => (
               <div
                  key={feature.index}
                  className="flex flex-col items-center p-6 bg-gradient-to-b from-zinc-50 to-zinc-100 dark:from-zinc-800 dark:to-zinc-900  rounded-xl shadow-lg hover:shadow-2xl transition duration-300 transform hover:scale-105 w-72 text-black dark:text-white"
               >
